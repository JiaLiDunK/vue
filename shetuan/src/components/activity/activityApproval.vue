      ...
      <el-container>
        ...
        <el-main>
            <el-table :data="tableData" border style="width: 100%">
                <el-table-column prop="activeName" label="活动名称" width="120px"  ></el-table-column>
                <el-table-column prop="time" label="申请时间" width="120px" ></el-table-column>
                <el-table-column prop="activeMoney" label="所需资金" width="120px" ></el-table-column>
                <el-table-column prop="name" label="负责人" width="120px" ></el-table-column>
                ...
                <el-table-column prop="site" label="地点" width="120px" ></el-table-column>
                <el-table-column prop="count" label="参与人数" width="120px" ></el-table-column>
                <el-table-column prop="desc" label="活动形式" width="120px" ></el-table-column>
...
export default {
  ...
  methods: {
      ...
      agree(row){
        ...
        this.axios({
              method: 'post',
              url: '/shetuan/active/changeState',
              data: data
            }).then((res)=>{
              console.log(res)
            if(res.data.code===0){
