      ...
      <el-container>
        ...
        <el-main>
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="moName" label="所属的社团" ></el-table-column>
                <el-table-column prop="phone" label="联系电话" ></el-table-column>
                <el-table-column prop="mailBox" label="邮箱" ></el-table-column>
                <el-table-column fixed="right" >
                <template #default="scope" label="操作">
                    <el-button @click="getOut(scope.row)"  size="small">踢出去</el-button>
                </template>
                </el-table-column>
            </el-table>
        </el-main>
...
export default {
  ...
  methods: {
      ...
      dianJi(page){
        ...
        this.axios({
              method: 'post',
              url: '/shetuan/member/getDataByMoId',
              data:data
            }).then((res)=>{
            if(res.data.code==0){
              ElMessage({
